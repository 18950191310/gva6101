<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="手机号">
          <el-input placeholder="搜索条件" v-model="searchInfo.phone"></el-input>
        </el-form-item>    
        <el-form-item label="性别">
          <el-input placeholder="搜索条件" v-model="searchInfo.sex"></el-input>
        </el-form-item>    
        ...
        <el-form-item label="地址">
          <el-input placeholder="搜索条件" v-model="searchInfo.address"></el-input>
        </el-form-item>    
        <el-form-item label="密码">
          <el-input placeholder="搜索条件" v-model="searchInfo.password"></el-input>
        </el-form-item>    
        <el-form-item label="微信号">
          <el-input placeholder="搜索条件" v-model="searchInfo.wechat"></el-input>
        </el-form-item>    
        <el-form-item label="伊瑟拉编号">
          <el-input placeholder="搜索条件" v-model="searchInfo.number"></el-input>
        </el-form-item>    
        <el-form-item>
          <el-button @click="onSubmit" type="primary">查询</el-button>
        </el-form-item>
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增用户详情</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="称呼" prop="name" width="120"></el-table-column> 
    ...
    <el-table-column label="伊瑟拉编号" prop="number" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateCuserDetail(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
export default {
  ...
  methods: {
      ...
      async onDelete() {
        ...
        const res = await deleteCuserDetailByIds({ ids })
        if (res.code == 0) {
          this.$message({
            type: 'success',
            message: '删除成功'
    ...
    async updateCuserDetail(row) {
      const res = await findCuserDetail({ ID: row.ID });
      this.type = "update";
      if (res.code == 0) {
    ...
    async deleteCuserDetail(row) {
      const res = await deleteCuserDetail({ ID: row.ID });
      if (res.code == 0) {
        this.$message({
          type: "success",
          message: "删除成功"
