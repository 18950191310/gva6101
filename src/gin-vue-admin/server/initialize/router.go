...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitCpuRouter(PrivateGroup)
		router.InitGpuRouter(PrivateGroup)
		router.InitHardRouter(PrivateGroup)
		router.InitMonitorRouter(PrivateGroup)
		router.InitOrderRouter(PrivateGroup)
		router.InitStorageRouter(PrivateGroup)
		router.InitRecolistRouter(PrivateGroup)
		router.InitCuserDetailRouter(PrivateGroup)
		router.InitRegisterRouter(PrivateGroup)
		router.InitRemarkRouter(PrivateGroup)
